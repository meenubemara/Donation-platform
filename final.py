...
style.configure("Treeview", background="white", foreground="black", rowheight=30, font=FONT_SMALL)
...
tk.Button(login_tab, text="Login", command=login_user,font=FONT_NORMAL, bg=BTN_COLOR, activebackground=BTN_ACTIVE).pack(pady=20)

# Register Tab
register_tab = ttk.Frame(tabControl)
tabControl.add(register_tab, text='Register')

tk.Label(register_tab, text="Name",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
reg_name = tk.Entry(register_tab)
reg_name.pack()

tk.Label(register_tab, text="Email",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
reg_email = tk.Entry(register_tab)
reg_email.pack()

tk.Label(register_tab, text="Username",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
reg_username = tk.Entry(register_tab)
reg_username.pack()

tk.Label(register_tab, text="Password",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
...
tk.Label(register_tab, text="Upload Aadhaar Image",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
tk.Button(register_tab, text="Browse Aadhaar", command=browse_aadhaar,font=FONT_NORMAL, bg=BTN_COLOR, activebackground=BTN_ACTIVE).pack()
tk.Label(register_tab, textvariable=aadhaar_path_var, wraplength=300).pack()

tk.Label(register_tab, text="Upload Selfie",font=FONT_NORMAL, bg=BG_COLOR).pack(pady=5)
tk.Button(register_tab, text="Browse Selfie", command=browse_selfie,font=FONT_NORMAL, bg=BTN_COLOR, activebackground=BTN_ACTIVE).pack()
tk.Label(register_tab, textvariable=selfie_path_var, wraplength=300).pack()

tk.Button(register_tab, text="Register", command=register_user,font=FONT_NORMAL, bg=BTN_COLOR, activebackground=BTN_ACTIVE).pack(pady=20)
